...
export const projectImage = [
    ...
    {name: 'Catch Me V 1', images: [catch_me_1, catch_me_2, catch_me_3, catch_me_4], description: "Me and my work team created a system anti-pest, this system can register and log an owner for his business, You can add employees in different branches, and watch if there are pests in your branches, it allows you to hire a technician to delete your problems, also if you are a technician and you don't have a job, you can work in our website!, Technicians and Owners can look how many pests there are in different branches.", link: 'https://github.com/gaelzamora/pest-control', technologies: [python, react, tailwind, typescript]}
]
...
export const projects = [
    ...
    {name: 'API Ecommerce with all functions', link: 'https://github.com/gaelzamora/gambit', description: 'A system that allows to manage your business ecommerce using AWS services such as Lambda, API Gateway, etc. Being a system full-scalable.', done: true},
    {name: 'Microservices with Django', link: 'https://github.com/gaelzamora/microservices', description: 'A system that allows to communicate different services beetween them, using services such as auth, blog (posts) and emails.', done: false}
]